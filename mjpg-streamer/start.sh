...
#./mjpg_streamer -i "input_uvc.so --help"
 ...
 ./mjpg_streamer -i "./input_uvc.so -d /dev/video0 -y -fps 30 -r 320*240" -o "./output_http.so -w ./www"#./mjpg_streamer -i "./input_uvc.so -d /dev/video0" -i "./input_uvc.so -d /dev/video1" -o "./output_http.so -w ./www"
